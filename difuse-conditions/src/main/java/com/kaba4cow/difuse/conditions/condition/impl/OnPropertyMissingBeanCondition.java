...
import com.kaba4cow.difuse.conditions.annotation.OnPropertyMissing;
...
public class OnPropertyMissingBeanCondition implements BeanCondition {
	...
	public boolean matches(BeanSource<?> beanSource) {
		String key = beanSource.getSourceElement().getAnnotation(OnPropertyMissing.class).value();
